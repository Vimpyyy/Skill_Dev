                ...
                <div className="react__title__section react__title__section2">
                    <div className="row align-v">
                        <div className="col-md-8">
                            <h2 className="react__tittle wow animate__fadeInUp" data-wow-duration="0.3s"> Popular Skills, Which are Most <b/> Favourite To Students </h2>
                        </div>
                        <div className="col-md-4 text-right wow animate__fadeInUp" data-wow-duration="0.5s">
                            <Link to="/about">
                                View more <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-arrow-right"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
                            </Link>
                        </div>
                    </div>
                </div>                       
                <div className="row pt---30">
                    ...
                    <div className="col-md-3 wow animate__fadeInUp" data-wow-duration="0.7s">
                        <div className="item__inner">                                    
                            ...
                            <div className="react-content">
                                <h3 className="react-title"><Link to="/course">Photography</Link></h3>
                                <p>24 Posts</p>
                            </div>                                    
                        </div>
                    </div>
