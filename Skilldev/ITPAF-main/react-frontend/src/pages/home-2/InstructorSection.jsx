                    ...
                    <div className="col-lg-6 col-md-4 col-sm-6">
                        <div className="instructor__content instructor__content-one">
                            <div className="instructors_lefts">
                                <h6 className="wow animate__fadeInUp" data-wow-duration="0.3s">Skill Sharing</h6>
                                <h2 className="wow animate__fadeInUp" data-wow-duration="0.3s">Meet our <br/> Top Contibutors</h2>
                            </div>
                        </div>
                    </div>
