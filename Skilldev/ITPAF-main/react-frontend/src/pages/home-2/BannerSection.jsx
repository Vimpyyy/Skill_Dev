    ...
    const counters = [
        {
            ...
            countText: 'Total number of users interacting with posts.',
            countSubText: 'k+',
        },
        {
            countNum: 70,
            countIcon: countIcon2,
            countText: 'Available fields to share you posts',
            countSubText: '+',
        }
        ...
        <div className="hero3__area p-relative">
            ...
            <div className="container p-relative">
                <div className="hero3__content">
                    <h1 className="hero3__title wow animate__fadeInUp" data-wow-duration="0.3s">Learn skills and share <br /> <em>New Today</em></h1>
