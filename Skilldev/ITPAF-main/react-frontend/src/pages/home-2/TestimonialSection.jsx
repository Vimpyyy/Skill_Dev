            ...
            <div className="react-clients react-clientso pt---120 pb---120">
                <div className="container">
                    <div className="react__title__section text-center">
                        <h6 className="react__subtitle wow animate__fadeInUp" data-wow-duration="0.3s">Great Words About Skillv.</h6>
                        <h2 className="react__tittle wow animate__fadeInUp" data-wow-duration="0.5s"> What our users say about </h2>
                    </div>
